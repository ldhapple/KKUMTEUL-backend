...
public class EventService {
    ...
    public void insertJoinEvent(Long userId, EventRequestDto eventRequestDto) {
        ...
        String issuedJoinEventCountStr = template.opsForValue().get(ISSUED_COUNT_KEY);
        long issuedJoinEventCount = (issuedJoinEventCountStr != null) ? Long.parseLong(issuedJoinEventCountStr) : 0L;
        ...
        if (newCount != null && newCount >= QUEUE_LIMIT) {
